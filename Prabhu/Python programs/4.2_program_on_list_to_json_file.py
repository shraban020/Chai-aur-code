...
print("Extract Info and create list")
print("-"*20)
# --------------
my_list = []
for each_line in list_of_lines:
...
import json
json.dump(my_list, my_json_file_handle)

my_json_file_handle.close()

print("Created log_report_2.json, Please check")
