"""
PACKAGES: We can keep modules in folders and subfolders.
...
e1 = myprojectlib.db.mymodule.Employee()
e1.set_name("emp-1")
...
from myprojectlib.db.mymodule import add, course, Employee
...
from myprojectlib.db.mymodule import add as a, course as c, Employee as E
